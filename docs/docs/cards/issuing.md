...
In this PIN Definition scenario, a token and signature must be generated by a customer back-end and provided to wishPIN's SDK. The signature will act as a proof of authentication. 
<br/>
