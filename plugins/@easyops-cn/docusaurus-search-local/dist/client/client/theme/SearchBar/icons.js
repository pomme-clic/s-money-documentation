...
export const iconNoResults = `<svg width="40" height="40" viewBox="0 0 23.8 23.8">
  <defs/>
  <path fill="currentColor" d="M11.9 23.8C5.3 23.8 0 18.4 0 11.9S5.3 0 11.9 0s11.9 5.3 11.9 11.9-5.4 11.9-11.9 11.9zm0-22C6.3 1.8 1.8 6.3 1.8 11.9S6.3 22 11.9 22 22 17.5 22 11.9 17.5 1.8 11.9 1.8z"/>
  <path fill="currentColor" d="M14.3 15.7c-.2 0-.4-.1-.6-.3l-4.9-5c-.3-.3-.3-.9 0-1.2s.9-.3 1.2 0l5 4.9c.3.3.3.9 0 1.2-.2.3-.4.4-.7.4z"/>
  <path fill="currentColor" d="M9.4 15.7c-.2 0-.4-.1-.6-.3-.3-.3-.3-.9 0-1.2l4.9-4.9c.3-.3.9-.3 1.2 0 .3.3.3.9 0 1.2l-5 5c-.1.1-.3.2-.5.2z"/>
</svg>
`
